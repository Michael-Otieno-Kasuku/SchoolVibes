"""
Django settings for schoolvibe project.
...
SECRET_KEY = 'django-insecure-&_*+=xu@1j@9*5px3=m)=9b0ye257iif_0&2vwmt%89350=a$2'
...
INSTALLED_APPS = [
    'uririconnect.apps.UririconnectConfig',
...
WSGI_APPLICATION = 'schoolvibe.wsgi.application'
...
APP_STATIC_ROOT = os.path.join(BASE_DIR, 'uririconnect/static')
